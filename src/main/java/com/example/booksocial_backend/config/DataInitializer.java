...
public class DataInitializer implements ApplicationRunner {
        ...
        public void run(ApplicationArguments args) {
                ...
                // ── Editoriales ───────────────────────────────────────────
                Editorial planeta = saveEditorial("Planeta Actualizada", "España");
                ...
                // ── Ediciones ─────────────────────────────────────────────
                Edition edHobbit1 = saveEdition("9780000000011", LocalDate.of(2001, 1, 1),
                                "El Hobbit (Edición revisada)", null, hobbit, planeta);
                Edition edHobbit2 = saveEdition("9780000000033", LocalDate.of(2005, 1, 1),
                                "El Hobbit (Edición revisada)", null, hobbit, norma);
                Edition edLotr1 = saveEdition("9780000000021", LocalDate.of(2002, 1, 1), "El Señor de los Anillos",
                                null, lotr, planeta);
                Edition edLotr2 = saveEdition("9780000000034", LocalDate.of(2010, 1, 1), "El Señor de los Anillos",
                                null, lotr, norma);
                Edition edGot1 = saveEdition("9780000000031", LocalDate.of(1998, 1, 1), "Juego de Tronos", null, got,
                                planeta);
                Edition edGot2 = saveEdition("9780000000033", LocalDate.of(2019, 3, 15),
                                "Juego de Tronos - Ed. Bolsillo", null, got, norma);
                Edition edGot3 = saveEdition("9780000000034", LocalDate.of(2022, 6, 1),
                                "A Game of Thrones - HarperCollins", null, got, harper);
                Edition edNow1 = saveEdition("9780000000054", LocalDate.of(2021, 9, 10),
                                "The Name of the Wind - HarperCollins", null, nameOfWind, harper);
                Edition edNow2 = saveEdition("9780000000067", LocalDate.of(2023, 1, 20),
                                "El nombre del viento - Debolsillo", null, nameOfWind, penguin);
                Edition edWayKings = saveEdition("9780000000074", LocalDate.of(2012, 5, 5), "El camino de los reyes",
                                null, wayOfKings, norma);
                Edition edFound1 = saveEdition("9780000000132", LocalDate.of(2010, 4, 22), "Fundación - Anaya", null,
                                foundation, anaya);
                Edition edFound2 = saveEdition("9780000000133", LocalDate.of(2020, 11, 5), "Foundation - HarperCollins",
                                null, foundation, harper);
                Edition edAndroid = saveEdition("9780000000142", LocalDate.of(2015, 2, 28),
                                "Blade Runner - Ed. Aniversario", null, doAndroidsDream, anaya);
                Edition ed2001 = saveEdition("9780000000151", LocalDate.of(1968, 6, 1), "2001: Una odisea espacial",
                                null, space2001, planeta);
                Edition edDune1 = saveEdition("9780000000162", LocalDate.of(2001, 3, 1), "Dune", null, dune, norma);
                Edition edIt1 = saveEdition("9780000000163", LocalDate.of(2022, 6, 18), "It - Edición 30 Aniversario",
                                null, it, norma);
                Edition edIt2 = saveEdition("9780000000183", LocalDate.of(2018, 7, 22), "It - HarperCollins", null, it,
                                harper);
                Edition edCthulhu = saveEdition("9780000000202", LocalDate.of(2018, 5, 12),
                                "La llamada de Cthulhu - Anaya", null, cthulhu, anaya);
                Edition edCrimen1 = saveEdition("9780000000054", LocalDate.of(2018, 3, 15),
                                "Crimen y castigo - Anaya Clásicos", null, crimeAndPunishment, anaya);
                Edition edCrimen2 = saveEdition("9780000000182", LocalDate.of(2018, 7, 22),
                                "Crime and Punishment - HarperCollins", null, crimeAndPunishment, harper);
                Edition edMeta = saveEdition("9780000000222", LocalDate.of(2021, 4, 5),
                                "La metamorfosis - Ed. Ilustrada", null, metamorphosis, anaya);
                Edition edExt = saveEdition("9780000000232", LocalDate.of(2022, 9, 14), "El extranjero - Ed. Especial",
                                null, stranger, norma);
                Edition ed1984 = saveEdition("9780000000243", LocalDate.of(2003, 6, 8), "1984", null, animalFarm,
                                norma);
                Edition edWitcher = saveEdition("9780000000253", LocalDate.of(2016, 4, 12),
                                "El último deseo - Salamandra", null, witcher, norma);
                Edition edWarPeace = saveEdition("9780000000263", LocalDate.of(2000, 9, 1), "Guerra y paz", null,
                                warAndPeace, planeta);
                Edition edOp1 = saveEdition("9780000000071", LocalDate.of(1997, 1, 1), "One Piece", 100, onePiece,
                                norma);
                Edition edOp2 = saveEdition("9780000000998", LocalDate.of(2024, 1, 1), "One Piece Edición Especial",
                                100, onePiece, norma);
                Edition edNar1 = saveEdition("9780000000061", LocalDate.of(2000, 1, 1), "Naruto", 72, naruto, norma);
                Edition edNar2 = saveEdition("9780000000024", LocalDate.of(2024, 1, 1), "Naruto Edición Deluxe", 72,
                                naruto, norma);
                Edition edBle1 = saveEdition("9780000000081", LocalDate.of(2002, 1, 1), "Bleach", 74, bleach, norma);
                Edition edBle2 = saveEdition("9780000000997", LocalDate.of(2022, 1, 1), "Bleach Edición Completa", 74,
                                bleach, norma);
                Edition edAot = saveEdition("9780000000091", LocalDate.of(2013, 1, 1), "Ataque a los Titanes", 34, aot,
                                norma);
                Edition edBer = saveEdition("9780000000101", LocalDate.of(2001, 1, 1), "Berserk", 41, berserk, planeta);
                Edition edFma = saveEdition("9780000000111", LocalDate.of(2003, 1, 1), "Fullmetal Alchemist", 27, fma,
                                norma);
                Edition edMon = saveEdition("9780000000121", LocalDate.of(2002, 1, 1), "Monster", 18, monster, norma);
                Edition edWatch1 = saveEdition("9780000000102", LocalDate.of(1987, 1, 1), "Watchmen", null, watchmen,
                                ecc);
                Edition edWatch2 = saveEdition("9780000000092", LocalDate.of(2020, 10, 1),
                                "Watchmen - Edición Absolute", null, watchmen, norma);
                Edition edDark1 = saveEdition("9780000000112", LocalDate.of(1987, 1, 1),
                                "Batman: El Regreso del Caballero Oscuro", null, darkKnight, ecc);
                Edition edDark2 = saveEdition("9780000000102", LocalDate.of(2016, 7, 19),
                                "Batman: El Regreso - Ed. Especial", null, darkKnight, norma);
                Edition edSand1 = saveEdition("9780000000122", LocalDate.of(1989, 1, 1), "Sandman", null, sandman, ecc);
                Edition edSand2 = saveEdition("9780000000111", LocalDate.of(2015, 1, 1), "Sandman", null, sandman,
                                norma);
