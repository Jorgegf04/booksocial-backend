...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        // ── Obras — imágenes locales del proyecto ─────────────────
        ...
        // ── Ediciones ─────────────────────────────────────────────
        Edition edOp  = saveEdition("978-84-679-1234-1", LocalDate.of(2000, 1,  1), "One Piece Vol. 1",            109, onePiece, norma);
        Edition edAot = saveEdition("978-84-679-2345-2", LocalDate.of(2013, 3, 15), "Ataque a los Titanes Vol. 1",  34, aot,      norma);
        Edition edBer = saveEdition("978-84-679-3456-3", LocalDate.of(2001, 6, 20), "Berserk Vol. 1",               41, berserk,  planeta);
        Edition edMon = saveEdition("978-84-679-4567-4", LocalDate.of(2002, 9, 10), "Monster Vol. 1",               18, monster,  planeta);
        Edition edNar = saveEdition("978-84-679-5678-5", LocalDate.of(2002, 3, 15), "Naruto Vol. 1",                72, naruto,   norma);
        Edition edBle = saveEdition("978-84-679-6789-6", LocalDate.of(2002, 10, 5), "Bleach Vol. 1",                74, bleach,   planeta);
        Edition edFma = saveEdition("978-84-679-7890-7", LocalDate.of(2002, 8, 22), "Fullmetal Alchemist Vol. 1",   27, fma,      ecc);
